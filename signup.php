...
<body>
  ...
  <section class="site-hero" style="background-image:url(images/cover_03.jpg)" id="section-home"
      ...
      <div class="row ">
        ...
        <div class="col-md-8 py-5 border">
          ...
          <form action="register.php" method="post">
            ...
            <div class="row py-2">
              <div class="form-group col-md-6">
                <input id="Password" name="Password" placeholder="Password" class="form-control" required="required"
                  type="password">
              </div>
            ...
            <div class="row py-2">
              <div class="form-group col-md-12">
                <textarea id="Address" name="address" placeholder="Address" cols="40" rows="5"
